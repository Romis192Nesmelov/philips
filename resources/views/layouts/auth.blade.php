        ...
        <div class="regular slider" style="margin-top: 30px;">
            <?php
                $items = [
                    ...
                    ['title' => 'Климатический комплекс<br>2 в 1','text' => 'Отслеживайте качество воздуха когда и где угодно. Этот климатический комплекс 2 в 1 эффективно увлажняет воздух и очищает его от загрязнений, вредных газов, частиц, бактерий и вирусов в помещениях площадью до 30 кв. м.'],
...
<section class="section section-05 footer">
    <div class="container">
        <p class="small-text">Не является публичной офертой. За каждый визит на АЗС «Шелл» клиент получает скретч-карты за покупку в одном чеке от 10 литров топлива Shell V-Power с октановым числом 95, Shell V-Power Racing (Рейсинг) с октановым числом 98, Shell V-Power Diesel (Дизель), а также любого из видов кофейных напитков, реализуемых на АЗС «Шелл», в любом объеме. Транзакции по приобретению топлива и кофе должны быть указаны в одном чеке. Список участвующих в акции товаров Philips, на которые можно получить скидки по купонам, представлен на сайте <a href="www.philips-shell-promo.ru">www.philips-shell-promo.ru</a>. Размер максимальной скидки на разные товары Philips отличается. С подробной информацией об организаторе и операторах акции, о правилах, порядке, сроках и условиях ее проведения можно ознакомиться на сайте <a href="shell.com.ru">shell.com.ru</a>.</p>
        <p class="small-text">* По вопросам гарантийного обслуживания товара Philips можно проконсультироваться при заказе.</p>
        <p class="small-text">** При участии в данной Акции сохраняются <a href="https://www.shop.philips.ru/faq/shipment_evo/free-delivery-evo.html#3500?from-home-free-delivery">специальные условия</a> "Бесплатной доставки".</p>
    </div>
</section>
